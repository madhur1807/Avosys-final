...
<header class="header-area navbar-fixed-top">
        ...
        <div class="row">
            <div id="menuzord" class="menuzord">
                <a href="index.php" class="menuzord-brand"><img src="images/logo.png" width="125" alt=""></a>
                        ...
                        <ul class="dropdown">
                            <li><a href="#">Services</a>
                                <ul class="dropdown">
                                    ...
                                    <li><a href="purchase-against-commercial-property.php">Purchase Against Commercial Property</a></li>
